...
quick_draw_data_set=["apple" , "carrot", "star" , "circle"];
timer_counter=0;
timer_check="";
drawn_sketch="";
answer_holder="";
...
document.getElementById("assignedsketch").innerHTML="Sketch to be drawn: "+Element_of_array;
...
if(error){
    ...
    document.getElementById("ursketch").innerHTML="Your sketch is : "+ drawn_sketch;
    document.getElementById("confidence").innerHTML="The accuracy is : " + results[0].confidence;
}
}
